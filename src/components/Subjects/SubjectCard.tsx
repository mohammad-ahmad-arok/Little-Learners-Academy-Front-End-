...
export const SubjectCard = ({ card }: subjectCard) => {
  return (
    ...
    >
      <div className="absolute bg-Orange_95 w-[25%] h-[55%] 2xl:h-[70%] top-0 border-2 border-Grey_15 rounded-b-xl -z-10"></div>
      <img src={card.image.url} className="z-10 w-auto" alt={card.name} />
      <div className="text-center flex flex-col ">
        <h5
          className="mb-[10px] mt-5 xl:mb-[14px] 2xl:mb-[20px] text-[22px] 
