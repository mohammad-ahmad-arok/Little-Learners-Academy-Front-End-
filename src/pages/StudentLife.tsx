...
const StudentLife = () => {
  ...
  >
    ...
    <div className="xl:w-[42%] flex flex-col items-center xl:items-start">
      ...
      Embracing Learning with Discovery and Joy      </h3>
    </div>
    <p
...
Welcome to our Student Life page, where the magic of childhood comes alive through the
 enriching experiences and adventures that our students embark on each day. At our kindergarten school, we
  believe that learning goes beyond textbooks, and we strive to create a holistic and engaging environment
   that nurtures every aspect of a child's development.    </p>
  </div>
  {/* features */}
